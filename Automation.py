...
class FalconAI:
    ...
    def setup_conversation_context(self):
        ...
        self.messages = [
            {
                "role": "system", 
                "content": "You are JARVIS, an advanced AI assistant created by Utkarsh Durgesh. You are designed to be helpful, safe, and efficient."
            },
            {
                "role": "system", 
    ...
    def generate_content(self, prompt, custom_config=None):
        ...
        try:
            ...
            model = genai.GenerativeModel(
                ...
                system_instruction="You are JARVIS. Your task is to generate high-quality content based on the provided prompt. You are writer you can write articles, blogs and code, based on user input, you will generate content that is clear, concise, and informative. Also use enojis in your response.",
            )
